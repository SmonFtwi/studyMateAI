...
export const ChartCard: React.FC<ChartCardProps> = ({ title, children }) => (
  <Card className="glass-cosmos border-slate-200 dark:border-white/10 shadow-sm hover:shadow-md transition-all duration-300  overflow-hidden">
...
export const CustomBarTooltip: React.FC<TooltipProps<number, string>> = ({
  active,
  payload,
  label,
}) => {
