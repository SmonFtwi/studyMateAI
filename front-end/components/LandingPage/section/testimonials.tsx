      ...
      <div className={`glass-cosmos p-10 rounded-[40px] border-white/10 hover:border-white/20 transition-all duration-700 relative overflow-hidden backdrop-blur-3xl h-full`}>
        ...
        <div className="flex items-center gap-5 mb-10">
          ...
          <div>
            ...
            <p className="text-sm text-purple-300/40 uppercase font-bold tracking-widest">{testimonial.role}</p>
          </div>
        </div>
        ...
        <div className="flex gap-1.5 mb-8">
          {[...Array(5)].map((_, i) => (
            <Star
              key={i}
              size={14}
              className={i < testimonial.rating ? "text-purple-400 fill-purple-400" : "text-white/10"}
            />
          ))}
        </div>
        ...
        <div className="relative">
          ...
          <p className="text-xl text-purple-100/70 font-medium leading-relaxed relative z-10 italic">
            "{testimonial.content}"
          </p>
        </div>
        ...
        <div className="mt-12 pt-8 border-t border-white/5 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <testimonial.icon className="w-5 h-5 text-purple-400/30" />
  ...
  return (
    <section className="py-60 relative">
      <div className="container mx-auto px-6 relative z-10">
        <div className="flex flex-col items-center text-center mb-32">
          ...
          >
            ...
            <span className="text-xs font-black tracking-[0.5em] text-purple-400 uppercase">Student Reviews</span>
            <div className="w-8 h-px bg-purple-500/50" />
          </motion.div>
          ...
          <motion.p
            ...
            className="text-xl text-purple-100/40 max-w-2xl font-medium"
          >
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full pointer-events-none -z-10">
        <div className="absolute top-[20%] left-[10%] w-96 h-96 bg-purple-600/10 blur-[140px] rounded-full animate-pulse" />
        <div className="absolute bottom-[20%] right-[10%] w-96 h-96 bg-blue-600/10 blur-[140px] rounded-full animate-pulse" style={{ animationDelay: '2s' }} />
      </div>
    </section>
  );
}
